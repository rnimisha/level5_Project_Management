  ...
  <div class="container mt-5 pt-5">
      ...
      <div class="col-lg-4 d-lg-block d-none">
        <div>
          <div class="img-container">
            <img src="image\banner\bannermini3.jpg" class="img-fluid category-banner"
                alt="banner">
          </div>
        </div>
        <div class=" mt-4">
          <div class="img-container">
            <img src="image\banner\tomato.jpg" class="img-fluid category-banner"
                alt="banner">
        </div>
        </div>
      </div>
      <div class="col-lg-8 ml-n1 pr-0">
        <div class="img-container banner-img">
          <img src="image\banner\bannerbg.jpg" class="img-fluid category-banner main-banner" id="text-img-banner"
              alt="banner">
          <img src="image\banner\frontorange.png" class="img-fluid main-banner bounce" id="over-img"
              alt="banner">
    ...
    <div class="row p-0 d-flex justify-content-center align-items-center">
          <div class="img-container col-lg-6 pl-0">
            <img src="image\banner\longbanner.jpg" class="img-fluid category-banner"
                alt="banner">
          </div>
          <div class="img-container col-lg-6 d-lg-flex d-none pr-0">
            <img src="image\banner1.png" class="img-fluid category-banner"
                alt="banner">
          </div>
